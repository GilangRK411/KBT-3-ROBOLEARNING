...
import robotHero from "@/assets/class/robotik/robot-2.png";
import kitThumb from "@/assets/class/robotik/robot-1.png";
...
const modules: ModuleItem[] = [
  { title: "Dasar Mekanika & Motor", status: "ongoing", summary: "Kontrol motor, servo, dan rangka dasar." },
  { title: "Sensor & Navigasi", status: "locked", summary: "Integrasi sensor jarak, encoder, dan mapping." },
  { title: "Visi Komputer & AI", status: "locked", summary: "Kamera, deteksi objek, dan gerak adaptif." },
];

const resources = [
  "Kit robotik: motor, roda, rangka, sensor jarak",
  "Template kode kontrol & logging",
  "Panduan tuning dan checklist keamanan",
];

export default function RobotikClassPage() {
  ...
  useEffect(() => {
    const needsMembership = RouteHelpers.requiresMembership(PROTECTED_ROUTES.classes.robotik);
      ...
      <main className="mx-auto max-w-screen-xl space-y-8 px-4 pb-16 pt-8">
        <section className="grid gap-6 rounded-[20px] border border-[#E5E7EB] bg-white p-6 shadow-sm md:grid-cols-[1.1fr_0.9fr] md:p-8">
          <div className="space-y-4">
            ...
            <h1 className="text-3xl font-bold leading-tight md:text-4xl">Kelas Robotik</h1>
            <p className="max-w-2xl text-sm text-[#4B5563]">
              Rakit, program, dan uji gerak robot dengan sensor, motor, dan visi komputer. Materi dibuat ringkas
              supaya cepat dipraktikkan.
            </p>
          ...
          <div className="flex flex-col gap-4 rounded-2xl border border-[#E5E7EB] bg-[#F8FAFC] p-5">
            <div className="flex items-center gap-3">
              <div className="h-16 w-16 overflow-hidden rounded-xl bg-white shadow-sm">
                <Image src={kitThumb} alt="Kit Robotik" className="h-full w-full object-cover" />
              </div>
              <div>
            ...
            <div className="rounded-xl border border-[#E5E7EB] bg-white p-4">
              <p className="text-sm font-semibold text-[#0F172A]">Kit & rangka</p>
              <p className="text-xs text-[#6B7280]">Pastikan rangka rapih, motor kencang, dan baterai penuh.</p>
            </div>
            <div className="overflow-hidden rounded-xl border border-[#E5E7EB] bg-white">
              <Image src={robotHero} alt="Ilustrasi Robotik" className="h-full w-full object-cover" />
            </div>
          </div>
        </section>
        ...
        <section id="resources" className="rounded-2xl border border-[#E5E7EB] bg-white p-5 shadow-sm md:p-6">
          <div className="flex items-center justify-between">
            ...
            <span className="text-[11px] font-semibold text-[#D72323]">Robotik</span>
          </div>
